...
module.exports = function (_ref, pluginOptions) {
  ...
  return new Promise(function (resolve, reject) {
    var getAST = function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(markdownNode) {
    ...
    var getHeadings = function () {
      var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(markdownNode) {
    ...
    var getTableOfContents = function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(markdownNode) {
        var cachedToc, ast, toc;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 9:
                ast = _context3.sent;
                toc = hastToHTML(toHAST(mdastToToc(ast).map));
    ...
    var getHTML = function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(markdownNode) {
        var cachedHTML, html;
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(pluginOptions.plugins), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (_.isFunction(requiredPlugin.setParserPlugins)) {
          ...
          try {
            for (var _iterator2 = (0, _getIterator3.default)(requiredPlugin.setParserPlugins()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var parserPlugin = _step2.value;
    ...
    return resolve({
      ...
      excerpt: {
        ...
        resolve: function resolve(markdownNode, _ref6) {
          var pruneLength = _ref6.pruneLength;

          return getAST(markdownNode).then(function (ast) {
            var textNodes = [];
            visit(ast, "text", function (textNode) {
              return textNodes.push(textNode.value);
            });
      ...
      headings: {
        ...
        resolve: function resolve(markdownNode, _ref7) {
