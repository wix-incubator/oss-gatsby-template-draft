...
.breadcrumbs-container {
  margin-left: -10px; }
  :global(.rtl) .breadcrumbs-container {
    margin-left: 0;
    margin-right: -10px; }
...
.back-button {
  ...
  .back-button button {
    ...
    .back-button button:active {
      ...
      width: 42px;
      height: 42px; }
  .back-button.dark-theme button {
    color: #FFFFFF; }
    .back-button.dark-theme button:hover {
...
.back-button-icon {
  ...
  width: 36px;
  height: 36px; }
  :global(.rtl) .back-button-icon {
    transform: scaleX(-1); }

.title-container {
  display: flex; }
  .title-container.minimized {
    position: absolute; }
...
.actions-bar {
  ...
  .actions-bar.with-breadcrumbs {
    margin-top: 36px; }
  .actions-bar.minimized {
    margin-top: -3px; }
