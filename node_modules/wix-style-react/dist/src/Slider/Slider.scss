...
:global(.wix-slider) :global(.rc-slider-rail) {
  background-color: #DAEFFE;
  border-radius: 5px;
  height: 6px;
  border-radius: 10px; }

:global(.wix-slider) :global(.rc-slider-track) {
  background-color: #3899EC;
  height: 6px;
  border-radius: 10px; }

:global(.wix-slider) :global(.rc-slider-dot) {
  display: none; }

:global(.wix-slider) :global(.mark-line) {
  position: relative;
  margin: auto;
  top: 6px;
  width: 1px;
...
:global(.wix-slider) :global(.mark-value) {
  position: relative;
  margin-top: 14px; }
