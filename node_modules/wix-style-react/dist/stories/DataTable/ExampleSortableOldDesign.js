...
var _DataTable = require('wix-style-react/DataTable');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_DataTable2.default, {
          ...
          itemsPerPage: 20,
          columns: [{ title: 'Row Number', render: function render(row, rowNum) {
              return '#' + (rowNum + 1);
            }, width: '20%', minWidth: '75px', important: true }, { title: 'First Name', sortable: true, sortDescending: !!this.state.sort[1], render: function render(row) {
              return _react2.default.createElement(
                'span',
                null,
                row.firstName
              );
            }, width: '40%', minWidth: '100px' }, { title: 'Last Name', sortable: true, sortDescending: !!this.state.sort[2], render: function render(row) {
              return _react2.default.createElement(
                'span',
                null,
                row.lastName
              );
            }, width: '40%', minWidth: '100px' }]
        })
      );
    }
  }]);
...
exports.default = DataTableSortableOldDesignExample;