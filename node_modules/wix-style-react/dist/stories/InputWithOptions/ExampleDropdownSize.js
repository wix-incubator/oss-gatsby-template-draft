...
exports.default = function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      'Bigger width',
      _react2.default.createElement(_InputWithOptions2.default, {
        dropdownWidth: '500px',
        options: options
      })
    ),
    _react2.default.createElement(
      ...
      { style: style, className: 'ltr' },
      'With offset',
      _react2.default.createElement(_InputWithOptions2.default, { dropdownWidth: '500px', dropdownOffsetLeft: '-150px', options: options })
    )
  );
};