...
var options = [{ value: 'Alabama', id: 'Alabama', tag: { label: 'Alabama' } }, { value: 'Alaska', id: 'Alaska' }, { value: _react2.default.createElement(
    'div',
    ...
    _react2.default.createElement('div', { className: _ExampleStandard2.default.thumb })
  ), id: 'Arizona', tag: { label: 'Arizona', thumb: _react2.default.createElement('div', { className: _ExampleStandard2.default.thumb }) } }, { value: 'Arkansas', id: 'Arkansas' }, { value: 'California', id: 'California' }, { value: 'California2', id: 'California2' }, { value: 'California3', id: 'California3' }, { value: 'California4', id: 'California4' }, { value: 'California5', id: 'California5' }, { value: 'California6', id: 'California6' }, { value: 'California7', id: 'California7' }, { value: 'Two words', id: 'Two words' }];

var valueParser = function valueParser(option) {
  return option.tag ? option.tag.label : option.value;
};

var ExampleWithLimitedNumRows = function (_React$Component) {
  _inherits(ExampleWithLimitedNumRows, _React$Component);

  function ExampleWithLimitedNumRows(props) {
    _classCallCheck(this, ExampleWithLimitedNumRows);

    var _this = _possibleConstructorReturn(this, (ExampleWithLimitedNumRows.__proto__ || Object.getPrototypeOf(ExampleWithLimitedNumRows)).call(this, props));

    _this.getValue = function (option) {
      return (0, _isString2.default)(option.value) ? option.value : option.value.props.children[0].props.children;
    };
    ...
    _this.handleOnRemoveTag = function (tagId) {
      return _this.setState({ tags: _this.state.tags.filter(function (currTag) {
  ...
  _createClass(ExampleWithLimitedNumRows, [{
    key: 'render',
  ...
  return ExampleWithLimitedNumRows;
}(_react2.default.Component);

exports.default = ExampleWithLimitedNumRows;