...
var ExampleWithoutOptions = function (_React$Component) {
  _inherits(ExampleWithoutOptions, _React$Component);

  function ExampleWithoutOptions(props) {
    _classCallCheck(this, ExampleWithoutOptions);

    var _this = _possibleConstructorReturn(this, (ExampleWithoutOptions.__proto__ || Object.getPrototypeOf(ExampleWithoutOptions)).call(this, props));
    ...
    _this.handleOnSelect = function (tags) {
      return _this.setState({ tags: [].concat(_toConsumableArray(_this.state.tags), _toConsumableArray(tags)) });
    };
  ...
  _createClass(ExampleWithoutOptions, [{
    key: 'render',
  ...
  return ExampleWithoutOptions;
}(_react2.default.Component);

exports.default = ExampleWithoutOptions;