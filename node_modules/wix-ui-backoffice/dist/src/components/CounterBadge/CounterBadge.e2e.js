...
describe('CounterBadge', function () {
    var storyUrl = protractor_2.getStoryUrl('Components', 'CounterBadge');
    beforeEach(function () { return protractor_1.browser.get(storyUrl); });
    afterEach(function () { return autoExampleDriver.reset(); });
    eyes.it('should display correct content', function () { return __awaiter(_this, void 0, void 0, function () {
        var driver, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    driver = protractor_3.counterBadgeTestkitFactory({ dataHook: 'storybook-counterBadge' });
                    return [4 /*yield*/, protractor_2.waitForVisibilityOf(driver.element(), 'Cannot find CounterBadge')];
                case 1:
                    _b.sent();
                    // await autoExampleDriver.setProps({children: '34'});
                    _a = expect;
                    return [4 /*yield*/, driver.getTextContent()];
                case 2:
                    // await autoExampleDriver.setProps({children: '34'});
...
//# sourceMappingURL=CounterBadge.e2e.js.map