...
var MoveTo = function (_a) {
    ...
    return (React.createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "currentColor", width: size || "24", height: size || "24" }, props),
        React.createElement("path", { d: "M6 7h3v4h4v2h1v-3l-4-4H6a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h7v-1H6V7zm4 .5l2.5 2.5H10V7.5zm6.5 4.5l3.5 3.5-3.5 3.5-.5-.5 2.5-2.5H13v-1h5.5L16 12.5l.5-.5z" })));
};
