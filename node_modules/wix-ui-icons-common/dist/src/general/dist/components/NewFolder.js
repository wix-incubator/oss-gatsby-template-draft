...
var NewFolder = function (_a) {
    ...
    return (React.createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "currentColor", width: size || "24", height: size || "24" }, props),
        React.createElement("path", { d: "M9.5 5H20v15H3V2h5l1.5 3zM4 6v13h15V6H4zm3.382-3H4v2h4.382l-1-2zM12 12h3v1h-3v3h-1v-3H8v-1h3V9h1v3z" })));
};
