...
var ZoomIn = function (_a) {
    ...
    return (React.createElement("svg", __assign({ viewBox: "0 0 24 24", fill: "currentColor", width: size || "24", height: size || "24" }, props),
        React.createElement("path", { d: "M16.436 15.73l2.625 2.624-.707.707-2.625-2.625a6.5 6.5 0 1 1 .707-.707zM11.5 17a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zm.5-6h2v1h-2v2h-1v-2H9v-1h2V9h1v2z" })));
};
